...
#
# Original Matlab script coded by: Shawn Lankton (www.shawnlankton.com)
#
# Python Port by kevin-keraudren (http://github.com/kevin-keraudren/chanvese)
#
#------------------------------------------------------------------------
...
def chanvese(I,init_mask,max_its=200,alpha=0.2,thresh=0,color='r',display=False, prog=False):
    ...
    if prog: pbar = Bar("Chanvese Iteration ", max=max_its)
