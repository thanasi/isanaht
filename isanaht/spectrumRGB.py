...
"""
code from : http://hsugawa.blogspot.com/2010/01/matplotlib-colormap-for-visible.html
Based on 
...
def wl_to_rgb(wl=arange(380.,781.)):
    return transpose([correct_r(wl),correct_g(wl),correct_b(wl)])
